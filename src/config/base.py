...
def parse_args(base_parser, args, namespace):
    ...
    parser.add_argument("--wandb_project", default="dykaf_fineweb", type=str)
    parser.add_argument(
    ...
    parser.add_argument("--dykaf_init", default="eps", type=str)
    parser.add_argument("--dykaf_rank_one", action="store_true")
    parser.add_argument("--dykaf_report_fisher_diff", action="store_true")
    parser.add_argument(
        "--mars_type",
        default="mars-adamw",
    ...
    parser.add_argument("--two_phase_switch_step", default=-1, type=int,
        help="Step at which to switch from D_1 to D_2 (only for dataset=fineweb_twophase). -1 = disabled.")
    parser.add_argument(
